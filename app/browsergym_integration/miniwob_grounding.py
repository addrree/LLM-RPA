    ...
    *,
    ...
    if before.lower().startswith("click") or before.lower().startswith("mouse_click") or target or target_bid:
        ...
        if selected is not None:
            ...
            is_datepicker_input = ("hasdatepicker" in cls) or ("datepicker" in sid) or ("date" in sid) or (_norm(selected.get("tag") or "") == "input" and "date" in ptxt)
            if parsed and parsed[0] == "click" and is_datepicker_input and candidate_id:
            ...
            if _is_textbox(selected) and candidate_id and not is_datepicker_input:
